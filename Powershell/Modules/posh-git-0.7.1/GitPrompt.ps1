...
# MODIFIED! ($NewLine parameter added)
function Write-Prompt($Object, $ForegroundColor = $null, $BackgroundColor = $null, $NewLine = $false) {
...
# MODIFIED!
		Write-Prompt '>'
		Write-Prompt $null -NewLine $true
# MODIFIED!
